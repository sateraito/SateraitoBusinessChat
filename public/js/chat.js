            ...
            if (!current_conversation) {
                ...
                $.post("/continue-conversation",
                    ...
                    function (result) {
                        ...
                        html_string += '<div id="chat_' + screen_id + '" class="chat_screen_body" data-conversation-id="' + result.conversation_id + '">';
                        if (message_string) {
                        ...
                        html_string += '<a href="javascript:void(0)" id="emoji_smile_' + screen_id + '" class="page_main_emoji_icon_tab footer_icon_active"><img src="image/emoji/smile_4.png"></a>';
                        ...
                        image_smiles.forEach(function(val) {
                           html_string += '<a href="javascript:void(0)" class="page_main_emoji_icon"><img src="' + val + '"></a>';
                        });
                        html_string += '</div>';

                        html_string += '<div class="content_main_emoji" id="animal_' + screen_id + '" style="display: none;">';
                        image_animals.forEach(function(val) {
                           html_string += '<a href="javascript:void(0)" class="page_main_emoji_icon"><img src="' + val + '"></a>';
                        });
                        html_string += '</div>';
                        html_string += '</div>';
                        ...
                        html_string += '<a href="javascript:void(0)" class="show_emotional_icon" id="show_emotional_' + screen_id + '"><img src="image/amotion-icon-normail.png"></a>';
//                        html_string += '<textarea class="message_text" name="message_text" placeholder="メッセージを送信"></textarea>';
                        html_string += '<div id="input_chat_' + screen_id + '" class="message_text input_chat" contentEditable=true data-text="メッセージを送信"></div>';
                        ...
                        $('#emoji_smile_' + screen_id).on('click', function() {
                            ...
                            $('#emoji_animal_' + screen_id).removeClass('footer_icon_active');
                        });
                        ...
                        $('#emoji_animal_' + screen_id).on('click', function() {
                            ...
                            $('#emoji_smile_' + screen_id).removeClass('footer_icon_active');
                        });

                        $('#animal_' + screen_id + ' .page_main_emoji_icon').on('click', function() {
//                            insertAtCaret("input_chat_" + screen_id, $(this)[0].children[0].src)
...
//                        $('.message_text').keyup(function (e) {
                        $("#input_chat_" + screen_id).keyup(function (e) {
                            clearTimeout(timer);
...
//                            var message_text = $(this).val();
                            var message_text = this.innerHTML;
                            ...
                            if (e.keyCode == 13) {
                                ...
                                var value_send = $.trim(message_text).replace(/\n\r?/g, '<br />');
                                ...
                                $.post("/send-a-message",
                                    ...
                                    function (data) {
                                        ...
                                        socket.emit("send a message", {
                                            ...
                                            conversation_title: conversation_title,
                                            message_id: message_id,
                                            message_text: $.trim(value_send).replace(/\n\r?/g, '<br />')
                                        });
                                    }
                                );
                            };
    ...
    $(".user_conversation_id").on("click", function () {
        ...
        $.post("/continue-conversation",
            ...
            function (data) {
                ...
                html_string += '</a>';
                html_string += '</div>';
                html_string += '<div id="chat_' + screen_id + '" class="chat_screen_body" data-conversation-id="' + conversation_id + '">';
                if (message_string) {
                    html_string += message_string;
                }
...
//    var socket = io(webSocketUri);
    ...
    html_string += '<div id="chat_' + screen_id + '" class="chat_screen_body" data-conversation-id="' + new_conversation_id + '"></div>';
...
function insertAtCaret(areaId, image_url) {
    var text = '<img src=' + image_url + '>';
    ...
    var back = (txtarea.innerHTML).substr(strPos, txtarea.innerHTML.length);
...
function pasteHtmlAtCaret(divId, image_url) {
